...
const FrontDeskSettings = ({ frontDeskUser }) => {
  ...
  const handleSaveSettings = () => {
    console.log('Front Desk Settings saved:', {
      notificationEnabled,
      preferredLanguage,
      emailUpdates,
    });
    ...
    <Box sx={{ p: { xs: 2, md: 4 }, maxWidth: 700, mx: 'auto', width: '100%' }}>
      ...
      <Box sx={{ mt: 6, opacity: 0.7, textAlign: 'center' }}>
        <Typography variant="body2" color="text.secondary">
          Configure front desk specific settings and preferences.
        </Typography>
      </Box>
    </Box>
  );
